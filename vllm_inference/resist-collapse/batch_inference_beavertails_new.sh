...
TEMPERATURE=0.1
TOP_P=0.95
OUTPUT_ROOT_DIR="/mnt/shared-storage-user/zhoujiayi/boyuan/datasets/PKU-SafeRLHF-new-jiayi/supervised/pos/model_collapse/round_1"
INPUT_FILE="/mnt/shared-storage-user/zhoujiayi/boyuan/datasets/PKU-SafeRLHF-new-jiayi/supervised/pos/train.jsonl"
...
MODEL_LIST=()
for dir in /mnt/shared-storage-user/zhoujiayi/boyuan/model_results/resist-collapse/1120_test_collapse_eval/safe_llama3.1-8b/*/slice_*/; do
    if [ -d "$dir" ]; then
        MODEL_LIST+=("$dir")
    fi
done
...
for MODEL_PATH in "${MODEL_LIST[@]}"; do
    ...
    python inverse_data_inference.py \
