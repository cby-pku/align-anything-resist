...
TEMPERATURE=0.1
TOP_P=0.95
OUTPUT_ROOT_DIR="/mnt/shared-storage-user/zhoujiayi/boyuan/data_results/rebound/yelp"
INPUT_FILE="/mnt/shared-storage-user/zhoujiayi/boyuan/datasets/preference_datasets/yelp/test_1000.json"
...
MODEL_LIST=()
for dir in /mnt/shared-storage-user/zhoujiayi/boyuan/model_results/rebound/yelp/rebound/*/; do
...
for dir in  /mnt/shared-storage-user/zhoujiayi/boyuan/model_results/rebound/yelp/main_process/*/; do
    slice_end_dir="${dir}/slice_end"
    if [ -d "$slice_end_dir" ]; then
        MODEL_LIST+=("$slice_end_dir")
    fi
