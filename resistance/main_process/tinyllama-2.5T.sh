...
MODEL_NAME_OR_PATH="/mnt/shared-storage-user/zhoujiayi/models/tinyllama/TinyLlama-1.1B-intermediate-step-1195k-token-2.5T" # model path
...
for dataset_label in ${DATASETS[@]}; do
    ...
    OUTPUT_DIR="${OUTPUT_ROOT_DIR}/${DATASET_LABEL}_tinyllama-2.5T"
