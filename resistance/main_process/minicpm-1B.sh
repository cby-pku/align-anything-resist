...
MODEL_NAME_OR_PATH="/mnt/shared-storage-user/zhoujiayi/models/openbmb/MiniCPM-1B-sft-bf16" # model path
...
for dataset_label in ${DATASETS[@]}; do
    ...
    OUTPUT_DIR="${OUTPUT_ROOT_DIR}/${DATASET_LABEL}_minicpm-1b"
