...
INPUT_ROOT_DIR = "/mnt/shared-storage-user/zhoujiayi/boyuan/rm_score_rebound/yelp/api_results"
OUTPUT_SUBDIR = "yelp"
VERBOSE = True
...
def parse_pos_neg_from_name(name: str) -> Optional[Tuple[int, int]]:
    ...
    neg_num = _parse_count_token(neg_token) if neg_token else 0
