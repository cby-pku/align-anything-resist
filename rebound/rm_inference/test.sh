...
# ==============================================================================
# 数据集所在的母目录
PARENT_DATA_DIR="/mnt/shared-storage-user/zhoujiayi/boyuan/data_results/rebound"
# 总输出目录的根目录
OUTPUT_ROOT_DIR="/mnt/shared-storage-user/zhoujiayi/boyuan/rm_score_rebound" # 如果环境变量未设置，则默认为 ../outputs
